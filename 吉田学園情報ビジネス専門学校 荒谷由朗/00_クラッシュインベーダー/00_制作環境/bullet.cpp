...
#define MAX_TYPE_BULLET			(6)									//弾の種類の最大数
#define BULLET_TEXTURENAME000	"data/TEXTURE/Bullet_kurisu2.png"			//読み込むテクスチャ
#define BULLET_TEXTURENAME001	"data/TEXTURE/bullet000.png"			//読み込むテクスチャ
...
void InitBullet(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, BULLET_TEXTURENAME001, &g_paTextureBullet[1]);
	D3DXCreateTextureFromFile(pDevice, BULLET_TEXTURENAME001, &g_paTextureBullet[2]);
	D3DXCreateTextureFromFile(pDevice, BULLET_TEXTURENAME001, &g_paTextureBullet[3]);
	D3DXCreateTextureFromFile(pDevice, BULLET_TEXTURENAME001, &g_paTextureBullet[4]);
	D3DXCreateTextureFromFile(pDevice, BULLET_TEXTURENAME001, &g_paTextureBullet[5]);
...
void UpdateBullet(void)
{
	...
	for (nCntBullet = 0; nCntBullet < MAX_BULLET; nCntBullet++)
	{
		...
		{	//弾が使用されている
			...
			{
				pVtx[nCntBullet * 4].col = D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f);
				pVtx[nCntBullet * 4 + 1].col = D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f);
				pVtx[nCntBullet * 4 + 2].col = D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f);
				pVtx[nCntBullet * 4 + 3].col = D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f);
			...
			else if (g_aBullet[nCntBullet].type == BULLETTYPE_PLAYER1)
			{
				pVtx[nCntBullet * 4].col = D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f);
				pVtx[nCntBullet * 4 + 1].col = D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f);
				pVtx[nCntBullet * 4 + 2].col = D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f);
			...
			{
				pVtx[nCntBullet * 4].col = D3DXCOLOR(0.0f, 0.0f, 1.0f, 1.0f);
				pVtx[nCntBullet * 4 + 1].col = D3DXCOLOR(0.0f, 0.0f, 1.0f, 1.0f);
				pVtx[nCntBullet * 4 + 2].col = D3DXCOLOR(0.0f, 0.0f, 1.0f, 1.0f);
				pVtx[nCntBullet * 4 + 3].col = D3DXCOLOR(0.0f, 0.0f, 1.0f, 1.0f);
			...
			Enemy *pEnemy;
			//敵の取得（先頭）
			if (g_aBullet[nCntBullet].type == BULLETTYPE_PLAYER || g_aBullet[nCntBullet].type == BULLETTYPE_PLAYER1 ||
				g_aBullet[nCntBullet].type == BULLETTYPE_PLAYER2)	//プレイヤーの弾
			{
				pEnemy = GetEnemy();
				for (nCntEnemy = 0; nCntEnemy < MAX_ENEMY; nCntEnemy++, pEnemy++)
				{
					...
					{
						if (pEnemy->pos.x + 35 > g_aBullet[nCntBullet].pos.x
							&& g_aBullet[nCntBullet].pos.x > pEnemy->pos.x - 35
							&& pEnemy->pos.y + 35 > g_aBullet[nCntBullet].pos.y
							&& g_aBullet[nCntBullet].pos.y > pEnemy->pos.y - 35)
						{	//当り判定
			...
			{
				SetEffect(g_aBullet[nCntBullet].pos, D3DXCOLOR(0.0f, 0.0f, 1.0f, 0.5f), 10);
			}
		}
		//頂点バッファのアンロック
		g_pVtxBuffBullet->Unlock();
