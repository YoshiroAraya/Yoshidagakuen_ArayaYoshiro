...
void UpdatePlayer(void)
{
	...
	//弾の設定
	if (g_player.nCunterAnim % 20 == 0 && g_player.bDisp == true)
	...
	//	SetBullet(g_player.pos, D3DXVECTOR3(sinf(D3DX_PI * 0.75f) * -5.0f, cosf(D3DX_PI * 0.125f) * -5.0f, 0.0f), BULLETTYPE_PLAYER, 0);
	//	PlaySound(SOUND_LABEL_SE_SHOT);
	//}
	...
	//{	//Zキーで弾を出す(左下斜め)
	//	SetBullet(g_player.pos, D3DXVECTOR3(sinf(D3DX_PI * 0.125f) * -5.0f, cosf(D3DX_PI * 0.75f) * -5.0f, 0.0f), BULLETTYPE_PLAYER, 0);
	//	PlaySound(SOUND_LABEL_SE_SHOT);
	//}
	...
	{	//Xキーで弾を出す(右下斜め)
		...
		SetBullet(g_player.pos, D3DXVECTOR3(sinf(D3DX_PI * 0.25f) * -1.0f, cosf(D3DX_PI * 0.1f) * -5.0f, 0.0f), BULLETTYPE_PLAYER1, 0);
		SetBullet(g_player.pos, D3DXVECTOR3(sinf(-D3DX_PI * 0.25f) * -1.0f, cosf(D3DX_PI * 0.1f) * -5.0f, 0.0f), BULLETTYPE_PLAYER2, 0);
		//SetBullet(g_player.pos, D3DXVECTOR3(sinf(D3DX_PI * 0.125f) * -5.0f, cosf(D3DX_PI * 0.75f) * -5.0f, 0.0f), BULLETTYPE_PLAYER3, 0);
		//SetBullet(g_player.pos, D3DXVECTOR3(sinf(-D3DX_PI * 0.125f) * -5.0f, cosf(D3DX_PI * 0.75f) * -5.0f, 0.0f), BULLETTYPE_PLAYER4, 0);
		PlaySound(SOUND_LABEL_SE_SHOT);
	}
