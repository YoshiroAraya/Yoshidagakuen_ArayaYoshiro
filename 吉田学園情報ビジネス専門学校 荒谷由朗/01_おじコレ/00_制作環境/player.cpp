...
void InitPlayer(void)
{
	...
	g_player.nLife = 5;
	g_player.fWidth = 30;			//幅
	g_player.fHeight = 50;			//高さ
	g_player.bDisp = true;
	g_player.bUse = true;
...
void UpdatePlayer(void)
{
	...
	{	//ジャンプ
		if (g_player.bJump == false)
		{
			...
			PlaySound(SOUND_LABEL_SE_PLEYERJUMP);
		}
	}
	...
	//if (g_player.pos.y >= SCREEN_HEIGHT - g_player.fHeight)
	//{	//落下制限
	//	g_player.pos.y = SCREEN_HEIGHT - g_player.fHeight;
	//	g_player.bJump = false;
	//}
