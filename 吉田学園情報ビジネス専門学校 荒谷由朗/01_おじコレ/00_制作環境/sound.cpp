...
{
	{"data/BGM/16 the WILD BUNCH.wav", -1},		// BGM_タイトル
	{"data/BGM/03 終末の四騎士.wav", -1},		// BGM_ゲーム
	{"data/BGM/10 Danza Kuduro.wav", -1},		// BGM_クリア
	{ "data/BGM/05 擦過する想い.wav", -1 },		// BGM_オーバー
	{"data/SE/akusyon_coinGet.wav", 0},			// コイン獲得
	{"data/SE/akusyon_ozisanGet_.wav", 0},		// おじさんゲット
	{"data/SE/akusyon_pleyerDamez_.wav", 0},	// ダメージ
	{"data/SE/akusyon_pleyerJump.wav", 0},		// ジャンプ
	{"data/SE/akusyon_pouzu_.wav", 0},			// ポーズ選択
	{"data/SE/akusyon_pryerBab_.wav", 0},		// 死亡
	{ "data/SE/akusyon_result_.wav", 0 },		// リザルト選択
	{ "data/SE/akusyon_serekuto_.wav", 0 }		// 選択音
};
