...
//　生成処理
//=============================================================================
CMeshField *CMeshField::Create(D3DXVECTOR3 pos, float width, float height, int meshX, int meshY)
{
...
HRESULT CMeshField::Init(void)
{
	...
	// テクスチャの読み込み(1体分)
	D3DXCreateTextureFromFile(pDevice, POYGON_TEXTURENAME00, &m_pTexture);
