...
// 静的メンバ変数
//=============================================================================
LPDIRECT3DTEXTURE9			CDescription::m_pTexture[DESCRIPTION_MAX_TEXTURE] = {};

//=============================================================================
//　コンストラクタ
//=============================================================================
CDescription::CDescription() :CScene2D(1)
{
	m_nSelect = NULL;
}
...
//　生成処理
//=============================================================================
CDescription *CDescription::Create(void)
{
	CDescription *pBg = NULL;

	pBg = new CDescription;
	pBg->Init();
...
//　ロード
//=============================================================================
HRESULT CDescription::Load(void)
{
	// デバイスの取得
	...
	// テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, DESCRIPTION_TEX00, &m_pTexture[0]);
	D3DXCreateTextureFromFile(pDevice, DESCRIPTION_TEX01, &m_pTexture[1]);
	D3DXCreateTextureFromFile(pDevice, DESCRIPTION_TEX02, &m_pTexture[2]);
	D3DXCreateTextureFromFile(pDevice, DESCRIPTION_TEX03, &m_pTexture[3]);
	D3DXCreateTextureFromFile(pDevice, DESCRIPTION_TEX04, &m_pTexture[4]);
	D3DXCreateTextureFromFile(pDevice, DESCRIPTION_TEX05, &m_pTexture[5]);
	D3DXCreateTextureFromFile(pDevice, DESCRIPTION_TEX06, &m_pTexture[6]);
...
//　アンロード
//=============================================================================
void CDescription::Unload(void)
{
	// テクスチャの破棄
	for (int nCntBg = 0; nCntBg < DESCRIPTION_MAX_TEXTURE; nCntBg++)
	{
...
// 初期化処理
//=============================================================================
HRESULT CDescription::Init(void)
{
	// 操作方法
