...
// グローバル変数宣言                                                      |
//------------------------------------------------------------------------
EnemyTex_0 *g_aEnemyTex;					// テキストデータの取得
ENEMY_0 *pEnemy;				// エネミーデータの取得
EnemyMotion_0 g_EnemyMotion;
int g_CntEnemyMotion_0 = 0;
...
void UpdateEnemyMotion_0(void)
{
	...
	if (g_CntEnemyMotion_0 % 1 == 0)
	{
		// エネミーの状態を取得
		ENEMYSTATUS_0 *pEnemyState;
		pEnemyState = GetEnemyStatus_0();
