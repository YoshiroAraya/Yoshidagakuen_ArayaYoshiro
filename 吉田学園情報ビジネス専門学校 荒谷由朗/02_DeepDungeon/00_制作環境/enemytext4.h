...
//
//=============================================================================
#ifndef _ENEMYTXT4_H_
#define _ENEMYTXT4_H_
...
typedef struct
{
	...
	EnemyModelTex_4 aModelTex[100];			// パーツ[各パーツの番号]
	EnemyMotionTex_4 aMotionTex[25][50][50];	// モーション[モーションの番号][キーフレームの番号][パーツの番号]
}EnemyTex_4;

//------------------------------------------------------------------------
// プロトタイプ宣言														  |
//------------------------------------------------------------------------
void LoadEnemyData_4(void);    // テキストのロード
EnemyTex_4 *GetEnemyTex_4(void);		// テキストデータの取得
