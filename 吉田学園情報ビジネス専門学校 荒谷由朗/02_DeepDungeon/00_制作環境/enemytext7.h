...
//
//=============================================================================
#ifndef _ENEMYTXT7_H_
#define _ENEMYTXT7_H_
...
typedef struct
{
	...
	EnemyModelTex_7 aModelTex[100];			// パーツ[各パーツの番号]
	EnemyMotionTex_7 aMotionTex[25][50][50];	// モーション[モーションの番号][キーフレームの番号][パーツの番号]
}EnemyTex_7;

//------------------------------------------------------------------------
// プロトタイプ宣言														  |
//------------------------------------------------------------------------
void LoadEnemyData_7(void);    // テキストのロード
EnemyTex_7 *GetEnemyTex_7(void);		// テキストデータの取得
