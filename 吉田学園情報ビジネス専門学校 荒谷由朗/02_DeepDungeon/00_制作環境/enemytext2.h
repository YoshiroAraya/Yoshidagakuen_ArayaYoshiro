...
//
//=============================================================================
#ifndef _ENEMYTXT2_H_
#define _ENEMYTXT2_H_
...
typedef struct
{
	...
	EnemyModelTex_2 aModelTex[100];			// パーツ[各パーツの番号]
	EnemyMotionTex_2 aMotionTex[25][50][50];	// モーション[モーションの番号][キーフレームの番号][パーツの番号]
}EnemyTex_2;

//------------------------------------------------------------------------
// プロトタイプ宣言														  |
//------------------------------------------------------------------------
void LoadEnemyData_2(void);    // テキストのロード
EnemyTex_2 *GetEnemyTex_2(void);		// テキストデータの取得
