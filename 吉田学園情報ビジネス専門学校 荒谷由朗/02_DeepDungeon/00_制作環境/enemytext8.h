...
//
//=============================================================================
#ifndef _ENEMYTXT8_H_
#define _ENEMYTXT8_H_
...
typedef struct
{
	...
	EnemyModelTex_8 aModelTex[100];			// パーツ[各パーツの番号]
	EnemyMotionTex_8 aMotionTex[25][50][50];	// モーション[モーションの番号][キーフレームの番号][パーツの番号]
}EnemyTex_8;

//------------------------------------------------------------------------
// プロトタイプ宣言														  |
//------------------------------------------------------------------------
void LoadEnemyData_8(void);    // テキストのロード
EnemyTex_8 *GetEnemyTex_8(void);		// テキストデータの取得
