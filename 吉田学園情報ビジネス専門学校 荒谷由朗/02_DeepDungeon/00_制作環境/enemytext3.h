...
//
//=============================================================================
#ifndef _ENEMYTXT3_H_
#define _ENEMYTXT3_H_
...
typedef struct
{
	...
	EnemyModelTex_3 aModelTex[100];			// パーツ[各パーツの番号]
	EnemyMotionTex_3 aMotionTex[25][50][50];	// モーション[モーションの番号][キーフレームの番号][パーツの番号]
}EnemyTex_3;

//------------------------------------------------------------------------
// プロトタイプ宣言														  |
//------------------------------------------------------------------------
void LoadEnemyData_3(void);    // テキストのロード
EnemyTex_3 *GetEnemyTex_3(void);		// テキストデータの取得
