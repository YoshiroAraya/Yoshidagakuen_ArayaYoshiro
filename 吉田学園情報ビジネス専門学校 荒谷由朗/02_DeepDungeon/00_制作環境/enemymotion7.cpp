...
// グローバル変数宣言                                                      |
//------------------------------------------------------------------------
EnemyTex_7 *g_aEnemyTex;					// テキストデータの取得
ENEMY_7 *pEnemy;				// エネミーデータの取得
EnemyMotion_7 g_EnemyMotion;
int g_CntEnemyMotion_7 = 0;
...
void UpdateEnemyMotion_7(void)
{
	...
	if (g_CntEnemyMotion_7 % 1 == 0)
	{
		// エネミーの状態を取得
		ENEMYSTATUS_7 *pEnemyState;
		pEnemyState = GetEnemyStatus_7();
