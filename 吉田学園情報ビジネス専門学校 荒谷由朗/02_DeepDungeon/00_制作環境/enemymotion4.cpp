...
// グローバル変数宣言                                                      |
//------------------------------------------------------------------------
EnemyTex_4 *g_aEnemyTex;					// テキストデータの取得
ENEMY_4 *pEnemy;				// エネミーデータの取得
EnemyMotion_4 g_EnemyMotion;
int g_CntEnemyMotion_4 = 0;
...
void UpdateEnemyMotion_4(void)
{
	...
	if (g_CntEnemyMotion_4 % 1 == 0)
	{
		// エネミーの状態を取得
		ENEMYSTATUS_4 *pEnemyState;
		pEnemyState = GetEnemyStatus_4();
