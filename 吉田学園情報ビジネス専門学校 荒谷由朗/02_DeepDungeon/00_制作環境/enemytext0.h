...
//
//=============================================================================
#ifndef _ENEMYTXT0_H_
#define _ENEMYTXT0_H_
...
typedef struct
{
	...
	EnemyModelTex_0 aModelTex[100];			// パーツ[各パーツの番号]
	EnemyMotionTex_0 aMotionTex[25][50][50];	// モーション[モーションの番号][キーフレームの番号][パーツの番号]
}EnemyTex_0;

//------------------------------------------------------------------------
// プロトタイプ宣言														  |
//------------------------------------------------------------------------
void LoadEnemyData_0(void);    // テキストのロード
EnemyTex_0 *GetEnemyTex_0(void);		// テキストデータの取得
