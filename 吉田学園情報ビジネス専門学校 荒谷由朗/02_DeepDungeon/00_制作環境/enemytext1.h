...
//
//=============================================================================
#ifndef _ENEMYTXT1_H_
#define _ENEMYTXT1_H_
...
typedef struct
{
	...
	EnemyModelTex_1 aModelTex[100];			// パーツ[各パーツの番号]
	EnemyMotionTex_1 aMotionTex[25][50][50];	// モーション[モーションの番号][キーフレームの番号][パーツの番号]
}EnemyTex_1;

//------------------------------------------------------------------------
// プロトタイプ宣言														  |
//------------------------------------------------------------------------
void LoadEnemyData_1(void);    // テキストのロード
EnemyTex_1 *GetEnemyTex_1(void);		// テキストデータの取得
