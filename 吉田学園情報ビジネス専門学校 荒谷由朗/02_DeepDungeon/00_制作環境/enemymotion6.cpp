...
// グローバル変数宣言                                                      |
//------------------------------------------------------------------------
EnemyTex_6 *g_aEnemyTex;					// テキストデータの取得
ENEMY_6 *pEnemy;				// エネミーデータの取得
EnemyMotion_6 g_EnemyMotion;
int g_CntEnemyMotion_6 = 0;
...
void UpdateEnemyMotion_6(void)
{
	...
	if (g_CntEnemyMotion_6 % 1 == 0)
	{
		// エネミーの状態を取得
		ENEMYSTATUS_6 *pEnemyState;
		pEnemyState = GetEnemyStatus_6();
