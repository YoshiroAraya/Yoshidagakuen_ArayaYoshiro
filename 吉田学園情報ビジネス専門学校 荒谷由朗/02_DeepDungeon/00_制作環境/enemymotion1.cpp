...
// グローバル変数宣言                                                      |
//------------------------------------------------------------------------
EnemyTex_1 *g_aEnemyTex;					// テキストデータの取得
ENEMY_1 *pEnemy;				// エネミーデータの取得
EnemyMotion_1 g_EnemyMotion;
int g_CntEnemyMotion_1 = 0;
...
void UpdateEnemyMotion_1(void)
{
	...
	if (g_CntEnemyMotion_1 % 1 == 0)
	{
		// エネミーの状態を取得
		ENEMYSTATUS_1 *pEnemyState;
		pEnemyState = GetEnemyStatus_1();
