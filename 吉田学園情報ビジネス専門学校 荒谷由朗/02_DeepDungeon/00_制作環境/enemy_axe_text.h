...
typedef struct
{
	...
	EnemyAxeModelTex aModelTex[100];			// パーツ[各パーツの番号]
	EnemyAxeMotionTex aMotionTex[25][50][50];	// モーション[モーションの番号][キーフレームの番号][パーツの番号]
}EnemyAxeTex;

//------------------------------------------------------------------------
// プロトタイプ宣言														  |
//------------------------------------------------------------------------
void LoadEnemyAxeData(void);    // テキストのロード
EnemyAxeTex *GetEnemyAxeTex(void);		// テキストデータの取得
