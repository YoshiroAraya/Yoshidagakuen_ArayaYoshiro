...
bool CollisionField(D3DXVECTOR3 *pPos, D3DXVECTOR3 *pPosOld, D3DXVECTOR3 *pMove, D3DXVECTOR3 *pVtxMin, D3DXVECTOR3 *pVtxMax)
{
	...
	///*if (pVtx[nCntCollision].bUse == true)
	//{*/
	...
	////当たり判定
	//for (int nCntCollision = 0; nCntCollision < MAX_POS; nCntCollision++)
	//{
	//	if (pVtx[nCntCollision].pos.x <= pPos->x
	//		&& pVtx[nCntCollision].pos.x + pVtx[nCntCollision].fWidth >= pPos->x)
	//	{//プレイヤーが上下の範囲内にいるかどうか
	//		MessageBox(NULL, "エラー", NULL, MB_YESNO);
	//		//if (pVtx[nCntCollision].pos.z <= pPos->z
	//		//	&& pVtx[nCntCollision].pos.z >= pPosOld->z)
	//		//{//上
	//		//	pPos->z = pVtx[nCntCollision].pos.z;
	//		//	pMove->z = 0.0f;
	//		//}
	//		//else if (pVtx[nCntCollision].pos.z + pVtx[nCntCollision].fHeight > pPos->z - 50
	//		//	&& pVtx[nCntCollision].pos.z + pVtx[nCntCollision].fHeight < pPosOld->z - 50)
	//		//{//下
	//		//	pPos->z = pVtx[nCntCollision].pos.z + pVtx[nCntCollision].fHeight + 50;
	//		//	pMove->z = 0.0f;
	//		//}
	//	}
	//	if (pVtx[nCntCollision].pos.z < pPos->z
	//		&& pVtx[nCntCollision].pos.z + pVtx[nCntCollision].fHeight + 50 > pPos->z)
	//	{//プレイヤーが左右の範囲内にいるかどうか
	//		MessageBox(NULL, "エラー", NULL, MB_YESNO);
	//		//if (pVtx[nCntCollision].pos.x - 15 >= pPosOld->x
	//		//	&& pVtx[nCntCollision].pos.x - 15 <= pPos->x)
	//		//{//左
	//		//	pPos->x = pVtx[nCntCollision].pos.x - 15;
	//		//	//pMove->x = 0.0f;
	//		//}
	//		//if (pVtx[nCntCollision].pos.x + pVtx[nCntCollision].fWidth + 15 <= pPosOld->x
	//		//	&& pVtx[nCntCollision].pos.x + pVtx[nCntCollision].fWidth + 15 >= pPos->x)
	//		//{//右
	//		//	pPos->x = pVtx[nCntCollision].pos.x + pVtx[nCntCollision].fWidth + 15;
	//		//	//pMove->x = 0.0f;
	//		//}
	//	}
	//}
